...
namespace APIVerve
{
    public class UsernameProfanityCheckerAPIClient
    {
        ...
        public UsernameProfanityCheckerAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public UsernameProfanityCheckerAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(usernameprofanityQueryOptions options)
        {
            try
            {
                if (_isDebug)
